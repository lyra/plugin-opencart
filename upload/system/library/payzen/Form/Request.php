...
class Request
{
     ...
     *
     * @var array[string][payzen\Form\Field]
     * @access private
     */
     ...
     *
     * @param array[string][payzen\Form\Field] $fields already filtered fields list
     * @param bool $hashed
     * @return string
     */
     ...
     *
     * @return array[string][payzen\Form\Field] a list of fields
     */
