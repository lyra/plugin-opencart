...
class ControllerExtensionPaymentPayzen extends Controller
{
    ...
    protected $configParams = array(
        ...
        'language', 'available_languages', 'capture_delay', 'validation_mode', 'payment_cards', '3ds_min_amount',
    ...
    protected function getFormData()
    {
        ...
        $data['text_payzen_support_email'] = PayzenApi::formatSupportEmails(PayzenTools::getDefault('SUPPORT_EMAIL'));
