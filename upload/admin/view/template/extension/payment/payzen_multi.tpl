...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            ...
            <?php if ($payzen_plugin_features['multi']) { ?>
...
<?php if (! $payzen_plugin_features['multi']) { ?>
        <div class="alert alert-warning" style="margin: 30px;"><?php echo $text_payzen_multi_not_available; ?></div>
    </div>
<?php } else {
    if ($payzen_plugin_features['restrictmulti']) { ?>
        <div class="alert alert-warning" style="margin: 30px;"><?php echo $text_payzen_multi_restriction_warn; ?></div>
<?php } ?>
    </div>
                        ...
                        <div class="tab-pane active" id="tab-general">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-13">
                                        <select id="payzen_multi_ctx_mode" name="payzen_multi_ctx_mode"<?php if ($payzen_plugin_features['qualif']) echo ' disabled="disabled"'; ?>>
                                            <option<?php if ($payzen_multi_ctx_mode === 'TEST') echo ' selected="selected"'; ?> value="TEST"><?php echo $text_payzen_test; ?></option>
                                            <option<?php if ($payzen_multi_ctx_mode === 'PRODUCTION') echo ' selected="selected"'; ?> value="PRODUCTION"><?php echo $text_payzen_production; ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="payzen_multi_sign_algo"><span data-toggle="tooltip" title="<?php echo $desc_payzen_sign_algo; ?>"><?php echo $entry_payzen_sign_algo; ?></span></label>
                                    <div class="col-sm-13">
                                        <select id="payzen_multi_sign_algo" name="payzen_multi_sign_algo">
                                            <option<?php if ($payzen_multi_sign_algo === 'SHA-1') echo ' selected="selected"'; ?> value="SHA-1">SHA-1</option>
                                            <option<?php if ($payzen_multi_sign_algo === 'SHA-256') echo ' selected="selected"'; ?> value="SHA-256">HMAC-SHA-256</option>
                                        </select>
                                    </div>
                                </div>
                               <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo $entry_payzen_url_check; ?></label>
                                    <label><b><?php echo HTTP_CATALOG.'index.php?route=extension/payment/payzen/callback'; ?></b>
                                    <br />
                                        <img src="view/image/payment/warn.png" alt="" style="vertical-align: bottom;"/>
                                        <span style="color: red; display: inline-flex;"><?php echo $desc_payzen_url_check; ?></span>
                                    </label>
                               </div>
                                <div class="form-group required">
                        ...
                        <div class="tab-pane" id="tab-specific">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-13">
                                        <input type="number" id="payzen_multi_count" name="payzen_multi_count" min="1" placeholder="<?php echo $entry_payzen_count; ?>" value="<?php echo $payzen_multi_count; ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-13">
                                        <input type="number" id="payzen_multi_period" name="payzen_multi_period" min="1" placeholder="<?php echo $entry_payzen_period; ?>" value="<?php echo $payzen_multi_period; ?>" />
                                    </div>
                                </div>
                            </fieldset>
                        </div>
