...
$_['text_payzen'] = '<a href="https://www.lyra.com" target="_blank"><img src="view/image/payment/payzen.png" alt="PayZen - Pagamento padrão" style="border: 1px solid #EEEEEE; width: 90px;" /></a>';
...
$_['entry_payment_payzen_platform_url'] = 'URL da página de pagamento';
...
$_['desc_payment_payzen_platform_url'] = 'URL para qual o comprador será redirecionado para o pagamento.';
