...
class PayzenTools
{
    ...
    private static $CMS_IDENTIFIER = 'OpenCart_4.x';
    private static $SUPPORT_EMAIL = 'support@payzen.eu';
    private static $PLUGIN_VERSION = '5.0.0';
    ...
    public static function getDocUrls()
    {
        ...
        foreach (PayzenApi::getOnlineDocUri() as $lang => $docUri) {
            $docs .= '<a style="margin-left: 10px; text-decoration: none; text-transform: uppercase;" href="' . $docUri . 'opencart4/sitemap.html" target="_blank">' . $languages[$lang] . '</a>';
        }
